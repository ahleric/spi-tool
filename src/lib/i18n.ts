...
export const translations = {
  zh: {
    ...
    searchLabel: "搜索艺人或歌曲",
    searchButtonText: "立即分析",
    brandTitle: "PEAK TIDE — 音乐增长",
    brandSubtitle: "我们用数据和创意内容，帮助独立音乐人在 Spotify 上持续获得真实听众。",
    spiIntroTitle: "想在 Spotify 被更多人听到？先认识 SPI",
  ...
  en: {
    ...
    brandTitle: "PEAK TIDE — Music Marketing",
